...
@implementation KAMessageAttachments {
    ::djinni::DbxCppWrapperCache<::Kullo::Api::MessageAttachments>::Handle _cppRefHandle;
}
...
- (nonnull NSArray *)allForMessage:(int64_t)msgId {
    try {
...
auto MessageAttachments::fromCpp(const CppType& cpp) -> ObjcType
{
    if (!cpp) {
        return nil;
    }
    return ::djinni::DbxCppWrapperCache<::Kullo::Api::MessageAttachments>::getInstance()->get(cpp, [] (const CppType& p) {
        return [[KAMessageAttachments alloc] initWithCpp:p];
    });
}
