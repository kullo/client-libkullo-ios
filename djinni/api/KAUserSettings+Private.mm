...
@implementation KAUserSettings {
    ::djinni::DbxCppWrapperCache<::Kullo::Api::UserSettings>::Handle _cppRefHandle;
}
...
auto UserSettings::fromCpp(const CppType& cpp) -> ObjcType
{
    if (!cpp) {
        return nil;
    }
    return ::djinni::DbxCppWrapperCache<::Kullo::Api::UserSettings>::getInstance()->get(cpp, [] (const CppType& p) {
        return [[KAUserSettings alloc] initWithCpp:p];
    });
}
