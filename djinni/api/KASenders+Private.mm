...
@implementation KASenders {
    ::djinni::DbxCppWrapperCache<::Kullo::Api::Senders>::Handle _cppRefHandle;
}
...
auto Senders::fromCpp(const CppType& cpp) -> ObjcType
{
    if (!cpp) {
        return nil;
    }
    return ::djinni::DbxCppWrapperCache<::Kullo::Api::Senders>::getInstance()->get(cpp, [] (const CppType& p) {
        return [[KASenders alloc] initWithCpp:p];
    });
}
