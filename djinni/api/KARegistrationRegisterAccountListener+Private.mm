...
public:
    ...
    {
        @autoreleasepool {
            [(ObjcType)Handle::get() challengeNeeded:(::ObjCpp::Kullo::Api::Address::fromCpp(c_address))
    ...
    {
        @autoreleasepool {
            [(ObjcType)Handle::get() addressNotAvailable:(::ObjCpp::Kullo::Api::Address::fromCpp(c_address))
...
auto RegistrationRegisterAccountListener::fromCpp(const CppType& cpp) -> ObjcType
{
    if (!cpp) {
        return nil;
    }
